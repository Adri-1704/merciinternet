  ...
  return (
    <div className="min-h-screen bg-zinc-50 text-zinc-900">
      ...
      <header className="sticky top-0 z-40 border-b border-zinc-200 bg-white">
        <div className="mx-auto flex max-w-lg sm:max-w-none items-center justify-between px-4 py-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <Link
              href="/plan-2026"
              className="hidden sm:flex items-center gap-1.5 rounded-lg bg-gradient-to-r from-violet-600 to-rose-600 px-3 py-1.5 text-xs font-semibold text-white transition-colors hover:from-violet-700 hover:to-rose-700"
              aria-label="Plan Financier 2026"
              title="Plan Financier 2026"
            >
              <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <button
              ...
              className="hidden sm:flex items-center justify-center rounded-lg bg-zinc-100 p-2 text-zinc-500 transition-colors hover:bg-zinc-200"
              title="Sauvegarde"
            >
      ...
      <div className="mx-auto max-w-lg sm:max-w-none px-4 pt-3 pb-1">
        {/* Mobile buttons: Plan 2026 + Prévisions + Factures + Export */}
        <div className="flex gap-2 mt-2 sm:hidden">
          <Link
            href="/plan-2026"
            className="flex-1 flex items-center justify-center gap-1.5 rounded-lg bg-gradient-to-r from-violet-600 to-rose-600 px-3 py-2 text-xs font-semibold text-white transition-colors hover:from-violet-700 hover:to-rose-700"
          >
            <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
            </svg>
